...
echo "=== dont_be_lazy basic_checks ==="
echo ""
echo "using: ${CLI_PYTHON} -m dont_be_lazy"
echo ""

echo "--- global flags ---"
check "dont_be_lazy --help"    run_cli --help
check "dont_be_lazy --version" run_cli --version

# TODO: add subcommand smoke checks here, e.g.:
# check "dont_be_lazy <subcommand> --help"  run_cli <subcommand> --help
